...
export default function Home(){
 ...
 return <><Nav/><main>
  ...
  <section className="homeProductProof"><div className="homeContainer">
    <div className="sectionIntro"><div className="eyebrow">VEJA O PRODUTO EM AÇÃO</div><h2>Um cockpit de preparação, não apenas uma coleção de ferramentas.</h2><p>A plataforma organiza prioridades, mostra onde você está perdendo pontos e transforma o progresso em próximos passos objetivos.</p></div>
    <div className="productProofGrid">
      <article className="productProofCard"><div className="productProofTop"><span>PLANO DE HOJE</span><b>04 tarefas</b></div><strong>Prioridade diária</strong><p>Leitura programada, questões, revisão e backlog reunidos em uma única rota.</p><div className="proofProgress"><i style={{width:"68%"}}/></div><small>68% da meta diária concluída</small><a href="/plataforma">Ver como funciona →</a></article>
      <article className="productProofCard"><div className="productProofTop"><span>PRONTIDÃO</span><b>68/100</b></div><strong>Diagnóstico explicável</strong><p>Domínio, cobertura, questões, simulados e consistência alimentam uma leitura única da preparação.</p><div className="proofSignals"><span>Domínio 74%</span><span>Consistência 81%</span><span>Revisão 59%</span></div><a href="/plataforma">Conhecer o painel →</a></article>
      <article className="productProofCard"><div className="productProofTop"><span>RIPEAM 3D</span><b>INTERATIVO</b></div><strong>Aprenda visualmente</strong><p>Explore luzes, marcas diurnas e situações de encontro com cenas tridimensionais publicadas pelo editor administrativo.</p><div className="proofLights"><i/><i/><i/></div><a href="/produtos/flashcards-mapas-mentais">Explorar recursos →</a></article>
    </div>
    <div className="productProofCta"><div><strong>Teste a experiência antes de decidir.</strong><p>Crie sua conta e conheça o ambiente de estudo com os recursos liberados no acesso inicial.</p></div><a className="btn primary" href="/cadastro">Criar conta e conhecer</a></div>
  </div></section>
