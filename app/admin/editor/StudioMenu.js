...
export default function StudioMenu({open,onClose,replacementMode,replacementType,selectionMode,onSelectionMode,siteMap,page,onPageChange,layers,onSelectLayer,blocks,selectedBlockId,onSelectBlock,onOpenBuilder,onOpenFlashcards,media,onUploadMedia,onAddIcon,onAddLogo,onAddSignalFlag,onImportImage,customCode,onCustomCode,breakpoints,onBreakpoints,onAddBreakpoint,onRemoveBreakpoint}){
