...
export function makeObject(base={}){
  return {
    id:crypto.randomUUID(),name:base.name||"Objeto",type:base.type||"model",assetUrl:base.assetUrl||"",assetType:base.assetType||"glb",visible:base.visible!==false,parentId:base.parentId||null,anchorName:base.anchorName||"",position:base.position||[0,0,0],rotation:base.rotation||[0,0,0],scale:base.scale||[1,1,1],pivot:base.pivot||[0,0,0],waterline:base.waterline??0,trim:base.trim??0,heel:base.heel??0,normalize:base.normalize!==false,color:base.color||"#ffffff",intensity:base.intensity??3,lightSize:base.lightSize??1,distance:base.distance??12,angle:base.angle??.75,penumbra:base.penumbra??.25,lightPreset:base.lightPreset||"",sector:base.sector??360,heading:base.heading??0,shape:base.shape||"ball",hotspot:base.hotspot||null,cable:base.cable||null,material:{mode:"original",color:"#ffffff",roughness:.5,metalness:.05,opacity:1,emissive:"#000000",doubleSide:false,...(base.material||{})}
  };
}
...
const CIS_PALETTES=[["#ffffff","#1965a0"],["#d71920"],["#1965a0","#ffffff","#d71920"],["#f3c51d","#1965a0"],["#1965a0","#d71920"],["#ffffff","#d71920"],["#f3c51d","#1965a0"],["#ffffff","#d71920"],["#f3c51d","#111111"],["#1965a0","#ffffff"],["#f3c51d","#1965a0"],["#f3c51d","#111111"],["#1965a0","#ffffff"],["#1965a0","#ffffff"],["#f3c51d","#d71920"],["#1965a0","#ffffff"],["#f3c51d"],["#d71920","#f3c51d"],["#ffffff","#1965a0"],["#d71920","#ffffff","#1965a0"],["#d71920","#ffffff"],["#ffffff","#d71920"],["#1965a0","#ffffff","#d71920"],["#ffffff","#1965a0"],["#f3c51d","#d71920"],["#f3c51d","#1965a0"]];
export const DECORATIVE_OBJECTS=CIS_CODES.map((code,index)=>({key:"cis-"+code.toLowerCase(),label:"Bandeira CIS — "+(CIS_NAMES[code]||("Numeral "+code)),type:"flag",flagCode:code,flagColors:CIS_PALETTES[index%26],position:[0,4.5,0],scale:[.9,.9,.9]})).concat([{key:"cis-sub1",label:"CIS — 1º substituto",type:"flag",flagCode:"S1",flagColors:["#1965a0","#f3c51d"],position:[0,4.5,0],scale:[.9,.9,.9]},{key:"cis-sub2",label:"CIS — 2º substituto",type:"flag",flagCode:"S2",flagColors:["#1965a0","#ffffff"],position:[0,4.5,0],scale:[.9,.9,.9]},{key:"cis-sub3",label:"CIS — 3º substituto",type:"flag",flagCode:"S3",flagColors:["#ffffff","#111111"],position:[0,4.5,0],scale:[.9,.9,.9]}]);
