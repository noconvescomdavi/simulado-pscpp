...
const seed=scrub({...raw,schema_version:1,source:"neon-export:weathered-mud-33091087"});delete seed.account_email;await fs.mkdir(path.dirname(dest),{recursive:true});await fs.writeFile(dest,JSON.stringify(seed));console.log("Standalone seed prepared:",dest);
