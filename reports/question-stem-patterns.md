# Padrões de enunciados — auditoria
...
| 11 | ao concluir a analise, durante a analise de uma prova de mar |
| 11 | para essa avaliacao, ao revisar o planejamento de uma manobra portuaria, o |
| 11 | sob essa otica, ao revisar o planejamento de uma manobra portuaria, o |
...
| 11 | ao concluir a analise, na avaliacao de desempenho apos alteracao da velocidade, |
| 11 | para interpretar corretamente o caso, na avaliacao de desempenho apos alteracao da |
| 11 | nesse contexto, na avaliacao de desempenho apos alteracao da velocidade, o topico |
| 11 | ao concluir a analise, durante uma comparacao entre condicao de projeto e |
| 11 | para interpretar corretamente o caso, durante uma comparacao entre condicao de projeto |
| 11 | nesse contexto, durante uma comparacao entre condicao de projeto e condicao operacional, |
| 11 | para essa avaliacao, durante uma comparacao entre condicao de projeto e condicao |
| 11 | para interpretar corretamente o caso, ao interpretar registros do passadico apos uma |
| 11 | nesse contexto, ao interpretar registros do passadico apos uma manobra, o topico |
| 11 | para essa avaliacao, ao interpretar registros do passadico apos uma manobra, o |
| 11 | sob essa otica, ao interpretar registros do passadico apos uma manobra, o |
...
| Ocorrências | Prefixo |
|---:|---|
| 20 | em uma situacao de corrente, baixa visibilidade ou trafego, qual risco e |
| 20 | em uma aproximacao com pratico e recursos integrados, qual acao materializa o |
| 20 | para distinguir controles proximos no passadico, como deve ser entendido o conceito |
| 20 | diante de informacao nova durante a derrota, qual procedimento aplica o controle |
| 20 | no passadico guarnecido para a fase critica, qual e a conduta adequada |
| 20 | ao combinar carta, sensores e observacao, o que deve ser feito para |
| 20 | em uma verificacao de conformidade do passadico, o que e correto sobre |
| 20 | com o navio ainda em condicao recuperavel, qual acao da efeito pratico |
| 20 | o navio aproxima-se de um trecho estreito, com corrente e trafego presentes. |
