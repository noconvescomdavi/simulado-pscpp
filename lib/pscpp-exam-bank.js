...
export function getPscppPool() {
  return [...valid(officialExams.questions), ...valid(generatedQuestions.questions), ...valid(arteNavalCap1Questions.questions), ...valid(arteNavalCap23Questions.questions), ...valid(arteNavalCap8Questions.questions), ...valid(generatedPscppBatchQuestions)];
}
