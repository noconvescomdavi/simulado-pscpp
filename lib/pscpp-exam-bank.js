...
export const PSCPP_SITUATIONAL_MINIMUMS = Object.freeze({
  manobrabilidade: 8,
...
export function buildPscppExam(seed=Date.now()) {
  return buildHistoricalExam(getPscppPool(), { seed, size: PSCPP_SIZE, quotas: PSCPP_SUBJECT_QUOTAS, situationalQuotas: PSCPP_SITUATIONAL_MINIMUMS });
}
export function pscppBlueprint(){
  return {
    ...
    situational_minimums:PSCPP_SITUATIONAL_MINIMUMS,
    situational_minimum_total:23,
    situational_minimum_percentage:Number((23 * 100 / PSCPP_SIZE).toFixed(2)),
    situational_policy:"minimum_not_ceiling",
