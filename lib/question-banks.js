...
function activeQuestions(bank) {
  // Final normalization gate: every source (base JSON, restoration or extension)
  // passes through the same quality transform immediately before it reaches
  // cadernos / Banco de Questões.
