...
const BANKS = {
  manobrabilidade: applyQuestionRestorations("manobrabilidade", manobrabilidade),
  "arte-naval": applyQuestionRestorations("arte-naval", arteNaval),
  "navegacao-aguas-restritas": navegacaoComRipeamTeorico,
  "situacoes-de-manobra-ripeam": ripeamSituacoes,
  "legislacao-regulamentacao": applyQuestionRestorations("legislacao-regulamentacao", legislacao),
  "meteorologia-oceanografia": applyQuestionRestorations("meteorologia-oceanografia", meteorologia),
  comunicacoes: applyQuestionRestorations("comunicacoes", comunicacoes),
  "conhecimentos-gerais": applyQuestionRestorations("conhecimentos-gerais", gerais),
};
