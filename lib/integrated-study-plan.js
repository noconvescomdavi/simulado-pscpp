...
const DAY = 86400000;
const FIRST_PASS_DEADLINE = "2027-07-30";
...
export async function getIntegratedStudyPlan(userId,weekOffset=0){
  ...
  for(const day of dayObjects){
    ...
    const isFriday=day.isoDay===5;
    day.tasks.push({
      key:(isFriday?"weekly-errors|":"review|")+day.iso,type:"review",subject:subject.slug,
      title:isFriday?"Revisão dos erros da semana":phase.key==="heavy_review"?"Revisão pesada — "+subject.label:"Revisão inteligente",
      description:isFriday
        ?"Revise obrigatoriamente os erros cometidos de sábado até quinta-feira. Erros reincidentes têm prioridade."
        :phase.key==="heavy_review"
          ...
          :"Revise erros e tópicos vencidos antes de avançar.",
      review_window:isFriday?"saturday_thursday":null,
      recurring_errors_priority:isFriday,
      href:isFriday?"/conteudos/caderno-de-erros?janela=semana&prioridade=reincidentes":"/revisao-inteligente"
    });
