...
export function getPaymentConfig() {
  ...
  const priceCents = positiveInteger(process.env.PSCPP_ANNUAL_PRICE_CENTS, DEFAULT_ANNUAL_PRICE_CENTS);
...
export function buildTutorPreference({orderId,email}) {
  ...
  return {
    items:[{id:"estibordo-tutor-ia-30",title:config.title,description:"Pacote adicional CONTRAMESTRE ESTIBORDO por 30 dias.",quantity:1,currency_id:"BRL",unit_price:config.priceCents/100}],
