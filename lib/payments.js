...
export function getPaymentConfig() {
  ...
  return {
    ...
    title: String(process.env.PSCPP_ANNUAL_PRODUCT_TITLE || "ESTIBORDO â€” acesso por 365 dias").slice(0, 120),
...
export async function mercadoPagoRequest(path, { method = "GET", body, idempotencyKey } = {}) {
  ...
  if (!accessToken) throw new Error("MERCADO_PAGO_ACCESS_TOKEN nÃ£o configurado.");
    ...
    items: [
      {
        ...
        title: config.title,
        description: "Acesso Ã  plataforma de estudos ESTIBORDO por 365 dias.",
        quantity: 1,
        currency_id: "BRL",
